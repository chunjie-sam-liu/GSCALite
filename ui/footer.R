...
shiny::fluidRow(
  ...
  column(
    ...
    column(
      width = 4,
      shiny::tags$p(class = "lead text-left", style = "color:#4CAF50;", "GSACLite"),
      shiny::tags$p(class = "text-left", "Version: 0.0.1")),
    column(
      width = 4,
      # Other Resources
    ...
    column(
      ...
      shiny::tags$p(shiny::tags$img(src = "./images/CRISPRAnalyzR_logo3_small.png", style = "width:200px;")),
      shiny::tags$p(shiny::tags$img(src = "./images/genomecrispr_logo_blue_transparent.png", style = "width:200px;")),
      shiny::tags$p(shiny::tags$img(src = "./images/logo_e_rgb.png", style = "width:200px;"))))
  )