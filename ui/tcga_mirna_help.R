              ...
              shiny::tags$table(
                ...
                shiny::tags$tbody(
                  shiny::tags$tr(
                    ...
                    shiny::tags$td("The networkD3 R package is used to generate this beautiful network, if you need to get a cool miRNA regulation network for your paper, it will be a nice choice. In this network, node size is positively correlate to the node's degree. Subgroups are generated by getting communities in a graph via random walks by igraph R package, and shown by different colors.")
                    ),
                  shiny::tags$tr(
