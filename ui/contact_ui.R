  ...
  fluidRow(
    ...
    column(
      ...
      shiny::tags$address(
        ...
        shiny::tags$p(shiny::tags$strong("College of Life Science and Technology, HUST")),
        shiny::fluidRow(
      ...
      # shiny::fluidRow(
      # shiny::column(width = 1, offset = 0, shiny::div(shiny::strong("Email: "))),
      # shiny::column(width = 3, offset = 0, shiny::plotOutput(outputId = "cj", height = "20px", width = "300px"))
      # )
      # ),
      shiny::tags$address(
        shiny::tags$p(shiny::tags$strong("Fei-Fei Hu, Ph.D. Lecturer")),
        shiny::tags$p(shiny::tags$strong("Brain Science and Advanced Technology Institute, WUST")),
        shiny::fluidRow(
          shiny::column(width = 1, offset = 0, shiny::div(shiny::strong("Email: "))),
