...
tabItem(
  ...
  fluidRow(
    ...
    column(
      ...
      shiny::tags$h1("User guide", align = "center"),
      
      shiny::tags$h1("1: Video guide"),
      shiny::tags$p("Folow the video, you can have a overall understanding about what you can get from GSCALite and how to use it."),
      shiny::tags$video(src = "./videos/guide_video.mp4", controls = "controls", width = "100%", height = "100%"),
      shiny::tags$br(),
      
      shiny::tags$h1("2: Step by step"),
      shiny::tags$img(
