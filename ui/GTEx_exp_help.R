                ...
                shiny::tags$div(class="panel panel-default",
                                shiny::tags$div(class="panel-heading",
                                                shiny::tags$h3(class="panel-title text-left",
                                                               HTML('<a data-toggle="collapse" href="#sqGTEx_expression">
                                                ...
                                                shiny::tags$div(class="panel-body",
												  ...
												  shiny::tags$tr(
                                                                                                  ...
                                                                                                  shiny::tags$tr(
                                                                                                    ...
                                                                                                    shiny::tags$td("The Gene Set Variation Analysis (GSVA) boxplot displays the estimating variation of gene set enrichment through the samples in the GTEx expression dataset. The dot denotes a sample in the given tissue.")
                                                                                                  ),
                                                                                                )
                                                                              )
