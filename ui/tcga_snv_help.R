              ...
              shiny::tags$table(
                ...
                shiny::tags$tbody(
                  shiny::tags$tr(
                    ...
                    shiny::tags$td("Give you SNV frequency of genes in each cancers. The deeper of color, the higher of mutate frequency. Nubers in each cell represent number of mutate samples.")
                  ),
                  shiny::tags$tr(
                    shiny::tags$td("SNV summay"),
