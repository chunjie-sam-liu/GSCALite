...
fluidRow(
  ...
  column(
    ...
    shiny::tags$div(
      ...
      shiny::tags$div(
        id = "sqTCGA_rppa", class = "panel-collapse collapse",
        shiny::tags$div(
          class = "panel-body",
            ...
            column(
              ...
              shiny::tags$table(
                ...
                shiny::tags$tbody(
                  ...
                  shiny::tags$tr(
                    shiny::tags$td("Hetmap percentage"),
                    shiny::tags$td("	Heatmap show you genes that have function (inhibit or activate) in at least 5 cancer types. Pathway_a represent activation of this pathway, inhibition in a similar way showed as pathway_i.")
                  ),
                  shiny::tags$tr(
